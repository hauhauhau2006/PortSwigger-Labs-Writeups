...
**SUBSTR(password, position, 1) = 'character' - check if a specific character exists at a specific position(like previous lab, password length is 20 characters)**
...
**After setting up, I find identify characters that trigger a 500 status code and the position on the left*
